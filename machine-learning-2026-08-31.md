...
title: "Machine Learning / AI Family Representative"
created: 2026-08-31
updated: 2026-08-31
...
# Machine Learning / AI Family Representative

This document represents the normalized candidate for the **Machine Learning / AI** strategy family. Hundreds of variants and parameterized versions exist in the source repository; this record captures the core economic mechanism and signal logic.
...
- Note: This candidate represents 6 variants/duplicates found in the source corpus. See `coverage_manifest.csv` for full lineage.
...
Statistical learning models predicting forward returns or state classifications.
...
- Entry: Based on Machine Learning / AI indicators crossing thresholds or each other.
- Exit: Reverse signal or predefined stop/profit.
- Parameter set: Highly variable across 6 family variants.
...
## Evidence
### Source-reported
Sources typically report positive backtest equity curves, but these are highly susceptible to parameter overfitting across the 6 variants. Not independently reproduced.
