...
Never collapse these stages. Qlib-only full backtest is the current runtime/backtest path. The downstream mirror is research-only, does not replace Qlib truth, and does not self-pass, self-rank, or self-promote entries.
