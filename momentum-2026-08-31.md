...
title: "Momentum / ROC Family Representative"
created: 2026-08-31
updated: 2026-08-31
...
sources:
  - https://github.com/fmzquant/strategies/blob/7853bb2bf262c4567ac238d3552d97f0e50cb801/多重动量指标趋势追踪量化交易策略-Multi-Momentum-Indicator-Trend-Tracking-Quantitative-Trading-Strategy.md
...
# Momentum / ROC Family Representative

This document represents the normalized candidate for the **Momentum / ROC** strategy family. Hundreds of variants and parameterized versions exist in the source repository; this record captures the core economic mechanism and signal logic.

## Provenance

- Repository: https://github.com/fmzquant/strategies
- Commit: 7853bb2bf262c4567ac238d3552d97f0e50cb801
- File path: 多重动量指标趋势追踪量化交易策略-Multi-Momentum-Indicator-Trend-Tracking-Quantitative-Trading-Strategy.md
- URL: https://github.com/fmzquant/strategies/blob/7853bb2bf262c4567ac238d3552d97f0e50cb801/多重动量指标趋势追踪量化交易策略-Multi-Momentum-Indicator-Trend-Tracking-Quantitative-Trading-Strategy.md
- Note: This candidate represents 190 variants/duplicates found in the source corpus. See `coverage_manifest.csv` for full lineage.
...
Trend following or reversal based on price velocity and rate of change.
...
- Entry: Based on Momentum / ROC indicators crossing thresholds or each other.
- Exit: Reverse signal or predefined stop/profit.
- Parameter set: Highly variable across 190 family variants.
...
## Evidence
### Source-reported
Sources typically report positive backtest equity curves, but these are highly susceptible to parameter overfitting across the 190 variants. Not independently reproduced.
